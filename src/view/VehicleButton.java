...
public class VehicleButton extends JButton{
      ...
      public void mouseClicked(MouseEvent e) {
        if (SwingUtilities.isRightMouseButton(e) || e.isControlDown()){
          ...
          case JOptionPane.OK_OPTION:
	  		  List<JCheckBox> checkBoxes = vehicleSettingPanel.getAttributeUsedCheckBoxes();
	  		  usedAttributes = 0;
  ...
  @Getter private int usedAttributes;
  @Getter private int loopNr;                           // CVN: 1
  @Getter private VehicleType vehicleType;              // CVN: 2
  @Getter private int lineNr;                           // CVN: 3
  @Getter private int vehServiceNr;                     // CVN: 4
  @Getter private int companyNr;                        // CVN: 5
  @Getter private int vehicleId;                        // CVN: 6
  @Getter private int signalGroupNr;                    // CVN: 7 KAR
  @Getter private ManualControl manualControl;          // CVN: 7 VECOM
  @Getter private VehicleStatus vehicleStatus;          // CVN: 8
  @Getter private PriorityClass priorityClass;          // CVN: 9
  @Getter private PunctualityClass punctualityClass;    // CVN: 10
  @Getter private int punctuality;                      // CVN: 11
  @Getter private int vehicleLength;                    // CVN: 12
  @Getter private int vehicleSpeed;                     // CVN: 13
  @Getter private int distanceToStop;                   // CVN: 14
  @Getter private int timeToStop;                       // CVN: 15
  @Getter private int journeyNr;                        // CVN: 16 
  @Getter private JourneyType journeyType;              // CVN: 17
  @Getter private int route;                            // CVN: 18
  @Getter private Direction direction;                  // CVN: 18 VECOM
  @Getter private Commands command;                     // CVN: 19
  @Getter private int activation;                       // CVN: 20
  @Getter private int latDeg;                           // CVN: 21a
  @Getter private int latMin;                           // CVN: 21b
  @Getter private int latSec;                           // CVN: 21c
  @Getter private int latSSec;                          // CVN: 21d
  @Getter private int longDeg;                          // CVN: 21e
  @Getter private int longMin;                          // CVN: 21f
  @Getter private int longSec;                          // CVN: 21g
  @Getter private int longSSec;                         // CVN: 21h
  @Getter private int year;                             // CVN: 22a
  @Getter private int month;                            // CVN: 22b
  @Getter private int day;                              // CVN: 22c
  @Getter private int hour;                             // CVN: 22d
  @Getter private int minute;                           // CVN: 22e
  @Getter private int second;                           // CVN: 22f
  @Getter private int reserve1;                         // CVN: 23
  @Getter private int reserve2;                         // CVN: 24
