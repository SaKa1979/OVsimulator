...
/**
 * @author Sander
 * @brief This is the main user interface frame and acts as manager for the
 *        panels shown on the main view
 * @category singleton
 */
public class ViewManager extends JFrame {
	...
	/**
	 * writes the currently pressed vehicle button settings to the feedback
	 * panel
	 * 
	 * @param a_vehiclebutton
	 */
	public void writeVehicleButtonSetting(ProtocolMessage protocolMessage) {
		String string = "";
		int fontSize = 12;
		...
		writeToFeedback(0, protocolMessage.toString(), Color.BLACK, fontSize);
	...
	private void initialize() {
		...
		FeedbackPanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Feedback",
		...
		bottomInfoVersionTxtpn.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Version",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		bottomInfoComSettingTxtpn.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				"Port settings", TitledBorder.LEADING, TitledBorder.TOP, null, null));

		ComNoticepanel = new JPanel();
		ComNoticepanel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "", TitledBorder.LEADING,
		...
		cbShowCommunication.setToolTipText(
				"When this checkbox is selected all the protocol communication between the OV-simulator and the host is displayed on the feedback screen. ");
		...
		bottomInfoComStatusTxtpn.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Port status",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		bottomInfoProtoTxtpn.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Protocol",
				TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		bottomInfoProtoXtraInfoTxtpn.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
				"Protocol settings", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		mntmPortSettings.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				int ok = JOptionPane.showConfirmDialog(null, portSettingPanel, "Port Setting",
						JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
				switch (ok) {
				case JOptionPane.OK_OPTION:
					// signal Communicator for we have some COM settings to
					// update
		...
		mnProtocol.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				int ok = JOptionPane.showConfirmDialog(null, protocolPanel, "Protocol Setting",
						JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
				switch (ok) {
				case JOptionPane.OK_OPTION:
